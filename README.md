...
## Usage
Clone this repository: `git clone https://github.com/iPh0ne4s/SSHRD_Script --recursive`
Run ` ./sshrd32.sh` use default version
## Args
Add ` --version=“ramdisk build”` use custom version,only support build version now
